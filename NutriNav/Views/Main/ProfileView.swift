    ...
    private var settingsSection: some View {
        VStack(alignment: .leading, spacing: Spacing.md) {
            ...
            Button(action: { showThemeSettings = true }) {
                settingsRowContent(title: "Display Theme", icon: "paintbrush.fill", iconColor: Color(hex: "9C27B0"))
            }
            ...
            Button(action: { showRestartOnboardingAlert = true }) {
                settingsRowContent(title: "Restart Onboarding", icon: "arrow.counterclockwise.circle.fill", iconColor: Color(hex: "FF9800"))
            }
            .alert("Restart Onboarding?", isPresented: $showRestartOnboardingAlert) {
                ...
                Text("You will need to re-enter your details.")
            }
...
struct ThemeSettingsView: View {
            ...
            ZStack {
                ...
                ScrollView {
                    VStack(spacing: Spacing.lg) {
                        ...
                        // Theme Options
                        VStack(spacing: 0) {
                            themeRow(title: "System Default", icon: "iphone", value: 0)
                            Divider().padding(.leading, 60)
                            themeRow(title: "Light Mode", icon: "sun.max.fill", value: 1)
                            Divider().padding(.leading, 60)
                            themeRow(title: "Dark Mode", icon: "moon.fill", value: 2)
                        }
                        .background(Color.cardBackground)
                        .cornerRadius(Radius.lg)
                        .padding(.horizontal, Spacing.md)
    ...
    private func themeRow(title: String, icon: String, value: Int) -> some View {
        Button(action: {
            HapticFeedback.selection()
            appTheme = value
        }) {
